...
/*
 * Provides tasks for building and testing the jec-commons project.
 */
module.exports = function(grunt) {
  ...
  //--> Task: builds the "jec-commons" project:
  grunt.registerTask("build", ["ts:build", "copy:main",
                               "copy:initTypes", "copy:buildTypesFile",
                               "clean:build"]);

  //--> Task: builds the "jec-commons" API documentation:
