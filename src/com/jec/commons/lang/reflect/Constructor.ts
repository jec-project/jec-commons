...
/**
 * The <code>Member</code> implementation for constructors.
 */
export class Constructor extends AbstractMember {
  ...
  /**
   * Creates a new <code>Constructor</code> instance. 
   * 
  ...
  constructor(declaringClass:any) {
    super(declaringClass.name, MemberType.CONSTRUCTOR, declaringClass);
  }
};
